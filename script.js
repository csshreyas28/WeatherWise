    ...
    if(cityvalue.length == 0){
        ...
        fetch(url, options)
            ...
            .then((response) =>{
                ...
                result.innerHTML = `
                <div class="heading mt-5"><h1 style="color: white;">This is how ${cityvalue} feels right now!</h1> </div>
                ...
                <div class="card mb-4 rounded-3 shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4" type="disc">
                      <li>Max Temperature : ${max_temp}&deg;C</li>
                      <li>Min Temperature : ${min_temp}&deg;C</li>
              ...
              <div class="col-md-3">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                  <div class="card-header py-3 text-bg-primary border-primary">
                    <h4 class="my-0 fw-normal">Sunset/Sunrise</h4>
                  </div>
                  <div class="card-body">
